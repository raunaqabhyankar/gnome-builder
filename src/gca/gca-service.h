...
/* ------------------------------------------------------------------------ */
/* Declarations for org.gnome.CodeAssist.v1.Completion */

#define GCA_TYPE_COMPLETION (gca_completion_get_type ())
#define GCA_COMPLETION(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), GCA_TYPE_COMPLETION, GcaCompletion))
#define GCA_IS_COMPLETION(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), GCA_TYPE_COMPLETION))
#define GCA_COMPLETION_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), GCA_TYPE_COMPLETION, GcaCompletionIface))

struct _GcaCompletion;
typedef struct _GcaCompletion GcaCompletion;
typedef struct _GcaCompletionIface GcaCompletionIface;

struct _GcaCompletionIface
{
  GTypeInterface parent_iface;

  gboolean (*handle_complete) (
...
GType gca_completion_get_type (void);

GDBusInterfaceInfo *gca_completion_interface_info (void);
guint gca_completion_override_properties (GObjectClass *klass, guint property_id_begin);


/* D-Bus method call completion functions: */
void gca_completion_complete_complete (
    GcaCompletion *object,
    GDBusMethodInvocation *invocation,
...
/* D-Bus method calls: */
void gca_completion_call_complete (
    GcaCompletion *proxy,
    const gchar *arg_path,
    const gchar *arg_data_path,
    GVariant *arg_cursor,
...
gboolean gca_completion_call_complete_finish (
    GcaCompletion *proxy,
    GVariant **out_unnamed_arg4,
    GAsyncResult *res,
    GError **error);

gboolean gca_completion_call_complete_sync (
    GcaCompletion *proxy,
    const gchar *arg_path,
    const gchar *arg_data_path,
    GVariant *arg_cursor,
...
#define GCA_TYPE_COMPLETION_PROXY (gca_completion_proxy_get_type ())
#define GCA_COMPLETION_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), GCA_TYPE_COMPLETION_PROXY, GcaCompletionProxy))
#define GCA_COMPLETION_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), GCA_TYPE_COMPLETION_PROXY, GcaCompletionProxyClass))
#define GCA_COMPLETION_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), GCA_TYPE_COMPLETION_PROXY, GcaCompletionProxyClass))
#define GCA_IS_COMPLETION_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), GCA_TYPE_COMPLETION_PROXY))
#define GCA_IS_COMPLETION_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), GCA_TYPE_COMPLETION_PROXY))

typedef struct _GcaCompletionProxy GcaCompletionProxy;
typedef struct _GcaCompletionProxyClass GcaCompletionProxyClass;
typedef struct _GcaCompletionProxyPrivate GcaCompletionProxyPrivate;

struct _GcaCompletionProxy
{
  /*< private >*/
  GDBusProxy parent_instance;
  GcaCompletionProxyPrivate *priv;
};

struct _GcaCompletionProxyClass
{
  GDBusProxyClass parent_class;
};

GType gca_completion_proxy_get_type (void);

void gca_completion_proxy_new (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
GcaCompletion *gca_completion_proxy_new_finish (
    GAsyncResult        *res,
    GError             **error);
GcaCompletion *gca_completion_proxy_new_sync (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
void gca_completion_proxy_new_for_bus (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
GcaCompletion *gca_completion_proxy_new_for_bus_finish (
    GAsyncResult        *res,
    GError             **error);
GcaCompletion *gca_completion_proxy_new_for_bus_sync (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
#define GCA_TYPE_COMPLETION_SKELETON (gca_completion_skeleton_get_type ())
#define GCA_COMPLETION_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), GCA_TYPE_COMPLETION_SKELETON, GcaCompletionSkeleton))
#define GCA_COMPLETION_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), GCA_TYPE_COMPLETION_SKELETON, GcaCompletionSkeletonClass))
#define GCA_COMPLETION_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), GCA_TYPE_COMPLETION_SKELETON, GcaCompletionSkeletonClass))
#define GCA_IS_COMPLETION_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), GCA_TYPE_COMPLETION_SKELETON))
#define GCA_IS_COMPLETION_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), GCA_TYPE_COMPLETION_SKELETON))

typedef struct _GcaCompletionSkeleton GcaCompletionSkeleton;
typedef struct _GcaCompletionSkeletonClass GcaCompletionSkeletonClass;
typedef struct _GcaCompletionSkeletonPrivate GcaCompletionSkeletonPrivate;

struct _GcaCompletionSkeleton
{
  /*< private >*/
  GDBusInterfaceSkeleton parent_instance;
  GcaCompletionSkeletonPrivate *priv;
};

struct _GcaCompletionSkeletonClass
{
  GDBusInterfaceSkeletonClass parent_class;
};

GType gca_completion_skeleton_get_type (void);

GcaCompletion *gca_completion_skeleton_new (void);
